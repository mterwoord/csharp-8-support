    ...
    public struct ManualResetValueTaskSourceCore<TResult>
    {
            ...
            if (oldContinuation != null)
            {
                ...
                switch (_capturedContext)
                {
                    case null:
                        ...
                        {
                            // change from corefx: had extra argument preferLocal: true
                            // change from corefx: callback was just direct value continuation
                            ThreadPool.QueueUserWorkItem(a=> continuation(a), state);
                        }
                        else
                        {
                            // change from corefx: had extra argument preferLocal: true
                            // change from corefx: callback was just direct value continuation
                            ThreadPool.UnsafeQueueUserWorkItem(a =>continuation(a), state);
                        }
                        break;
        ...
        private void SignalCompletion()
        {
            ...
            if (_continuation != null || Interlocked.CompareExchange(ref _continuation, ManualResetValueTaskSourceCoreShared.s_sentinel, null) != null)
            {
                if (_executionContext != null)
                {
                    // change from corefx: old code begin:
        ...
        private void InvokeContinuation()
        {
            switch (_capturedContext)
            {
                case null:
                    ...
                    {
                        // change from corefx: was not here:
                        var continuation = _continuation;
                        if (_executionContext != null)
                        {
                            // change from corefx: had extra argument preferLocal: true
                            // change from corefx: callback was just direct value continuation
                            ThreadPool.QueueUserWorkItem(a=>continuation(a), _continuationState);
                        }
                        else
                        {
                            // change from corefx: had extra argument preferLocal: true
                            // change from corefx: callback was just direct value continuation
                            ThreadPool.UnsafeQueueUserWorkItem(a => continuation(a), _continuationState);
                        }
                    }
                    else
                    {
