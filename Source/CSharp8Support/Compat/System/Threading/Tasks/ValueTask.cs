...
namespace System.Threading.Tasks
{
    ...
    public readonly struct ValueTask : IEquatable<ValueTask>
    {
        ...
        private static readonly Task s_canceledTask = TaskEx.FromCanceled(new CancellationToken(canceled: true));

        /// <summary>A successfully completed task.</summary>
        internal static Task CompletedTask => TaskEx.CompletedTask;
        ...
        private Task GetTaskForValueTaskSource(IValueTaskSource t)
        {
            ...
            // change from corefx: was without .Task
        ...
        ///  change from corefx: was basetype Task
        private sealed class ValueTaskSourceAsTask : TaskCompletionSource<object>
        {
            private static readonly Action<object> s_completionAction = state =>
            {
                ...
                try
                {
                    ...
                    // change from corefx: was without argument
                    vtst.TrySetResult(null);
                }
                catch (Exception exc)
                {
                    if (status == ValueTaskSourceStatus.Canceled)
                    {
                        if (exc is OperationCanceledException oce)
                        {
                            // change from corefx: was with second argument oce
        ...
        public bool IsCompletedSuccessfully
        {
            ...
            get
            {
                ...
                if (obj is Task t)
                {
                    // change from corefx: was return t.IsCompletedSuccessfully;
        ...
        internal void ThrowIfCompletedUnsuccessfully()
        {
            ...
            if (obj != null)
            {
                if (obj is Task t)
                {
                    ...
                    if (t.IsFaulted)
                    {
                        // change from corefx was TaskAwaiter.ValidateEnd(t);
    ...
    public readonly struct ValueTask<TResult> : IEquatable<ValueTask<TResult>>
    {
        ...
        public Task<TResult> AsTask()
        {
            ...
            if (obj == null)
            {
                // change from corefx: old code was return AsyncTaskMethodBuilder<TResult>.GetTaskForResult(_result);
        ...
        private Task<TResult> GetTaskForValueTaskSource(IValueTaskSource<TResult> t)
        {
            ...
            if (status != ValueTaskSourceStatus.Pending)
            {
                try
                {
                    ...
                    // change from corefx: was return AsyncTaskMethodBuilder<TResult>.GetTaskForResult(t.GetResult(_token));
                ...
                catch (Exception exc)
                {
                    if (status == ValueTaskSourceStatus.Canceled)
                    {
                        if (exc is OperationCanceledException oce)
                        {
                            // change from corefx: old code start:
                            //var task = new Task<TResult>();
                            //task.TrySetCanceled(oce.CancellationToken, oce);
                            //return task;
                            // old code end

                            return TaskEx.FromCanceled<TResult>(oce.CancellationToken);
                        ...
                        if (canceledTask == null)
                        {
                            ...
                            s_canceledTask = TaskEx.FromCanceled<TResult>(new CancellationToken(true));
                        }
                        return canceledTask;
                    }
                    else
                    {
                        return TaskEx.FromException<TResult>(exc);
                    }
                }
            }
        ...
        // change from corefx: was basetype Task<T>
            ...
            private static readonly Action<object> s_completionAction = state =>
            {
                ...
                catch (Exception exc)
                {
                    if (status == ValueTaskSourceStatus.Canceled)
                    {
                        if (exc is OperationCanceledException oce)
                        {
                            // change from corefx: was with second argument: ece
                            vtst.TrySetCanceled(oce.CancellationToken);
                        }
                        else
                        {
        ...
        public TResult Result
        {
            ...
            get
            {
                ...
                if (obj is Task<TResult> t)
                {
                    // change from corefx. begin old code
                    ...
                    if (t.IsFaulted)
                    {
                        throw new InvalidOperationException("Error getting result", t.Exception);
                    }
