...
namespace System
{
    internal static class ThrowHelper
    {
        ...
        {
            throw new ArgumentException(EnvironmentEx.GetResourceString("Arg_WrongType", key, (object)targetType), nameof(key));
        }

        internal static void ThrowWrongValueTypeArgumentException(object value, Type targetType)
        {
            throw new ArgumentException(EnvironmentEx.GetResourceString("Arg_WrongType", value, (object)targetType), nameof(value));
        }
        ...
        {
            throw new ArgumentException(EnvironmentEx.GetResourceString(ThrowHelper.GetResourceName(resource)));
        }
        ...
        {
            throw new ArgumentException(EnvironmentEx.GetResourceString(ThrowHelper.GetResourceName(resource)), ThrowHelper.GetArgumentName(argument));
        }
        ...
        internal static void ThrowArgumentOutOfRangeException(
          ...
          ExceptionResource resource)
        {
            // change from corefx: next if statement was enabled
            //if (CompatibilitySwitches.IsAppEarlierThanWindowsPhone8)
            //    throw new ArgumentOutOfRangeException(ThrowHelper.GetArgumentName(argument), string.Empty);
            throw new ArgumentOutOfRangeException(ThrowHelper.GetArgumentName(argument), EnvironmentEx.GetResourceString(ThrowHelper.GetResourceName(resource)));
        }
        ...
        {
            throw new InvalidOperationException(EnvironmentEx.GetResourceString(ThrowHelper.GetResourceName(resource)));
        }

        internal static void ThrowSerializationException(ExceptionResource resource)
        {
            throw new SerializationException(EnvironmentEx.GetResourceString(ThrowHelper.GetResourceName(resource)));
        }

        internal static void ThrowSecurityException(ExceptionResource resource)
        {
            throw new SecurityException(EnvironmentEx.GetResourceString(ThrowHelper.GetResourceName(resource)));
        }

        internal static void ThrowNotSupportedException(ExceptionResource resource)
        {
            throw new NotSupportedException(EnvironmentEx.GetResourceString(ThrowHelper.GetResourceName(resource)));
        }

        internal static void ThrowUnauthorizedAccessException(ExceptionResource resource)
        {
            throw new UnauthorizedAccessException(EnvironmentEx.GetResourceString(ThrowHelper.GetResourceName(resource)));
        }

        internal static void ThrowObjectDisposedException(string objectName, ExceptionResource resource)
        {
            throw new ObjectDisposedException(objectName, EnvironmentEx.GetResourceString(ThrowHelper.GetResourceName(resource)));
        }
